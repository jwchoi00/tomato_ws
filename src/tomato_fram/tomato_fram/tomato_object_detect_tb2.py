...
class TomatoDetectionNode(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            Image, '/tb2/camera/image_raw', self.image_callback, 10
        )
        self.publisher = self.create_publisher(Image, '/tb2/tomato/image', 10)
        self.detect_publisher = self.create_publisher(TomatoDetected, '/tb2/tomato/detected', 10)
