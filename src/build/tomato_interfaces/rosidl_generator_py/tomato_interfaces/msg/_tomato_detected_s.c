...
bool tomato_interfaces__msg__tomato_detected__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tomato_interfaces.msg._tomato_detected.TomatoDetected", full_classname_dest, 53) == 0);
  }
  tomato_interfaces__msg__TomatoDetected * ros_message = _ros_message;
  {  // detected
...
{
  /* NOTE(esteve): Call constructor of TomatoDetected */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tomato_interfaces.msg._tomato_detected");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TomatoDetected");
